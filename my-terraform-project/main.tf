terraform {
  backend "s3" {
    bucket= "enis-terraform-for-state-file-0125-1364250b" # Replace with your S3 bucket name
...
resource "aws_s3_bucket_object" "private_key_object" {
  bucket = "enis-terraform-for-state-file-0125-1364250b" # Reference existing S3 bucket
